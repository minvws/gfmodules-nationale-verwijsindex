...
def test_from_request_should_succeed(auth_headers_dict: Dict[str, Any], auth_headers: AuthHeaders) -> None:
    ...
    headers = auth_headers_dict.copy()
...
# good = {
#     "x-audience": "https://nvi.test.gf.irealisatie.nl",
#     "x-source-id": "source pro max 1000",
#     "x-scope": "epd:read",
#     "x-oin-number": "00000009234567890000",
#     "x-ura-number": "90000103",
#     "x-authorized-role": "authorized_role",
# }
#
#
# bad = {
#     "x-audience": "some-audience",
#     "x-source-id": "source pro max 1000",
#     "x-scope": "epd:read",
#     "x-oin-number": "00000009234567890000",
#     "x-ura-number": "90000103",
