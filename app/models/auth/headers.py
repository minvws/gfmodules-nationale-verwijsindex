...
class AuthHeaders(BaseModel):
    ...
    oin_number: str | None = Field(alias="x-gf-oin-number", default=None)
    source_id: str | None = Field(alias="x-gf-source-id", default=None)
    ura_number: str = Field(alias="x-gf-ura-number")
    ...
    def from_request_or_none(cls, req: Request) -> Self | None:
        try:
            ...
            logger.error(f"Error occurred while creating AuthHeaders: {e}")
            return None
