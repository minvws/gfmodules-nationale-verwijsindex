...
def query(
    ...
    authorized_ura = request.state.auth.claims.ura_number
...
def delete(
    ...
    authorized_ura: UraNumber = request.state.auth.claims.ura_number
...
def delete_for_query(
    ...
    authenticated_ura = request.state.auth.claims.ura_number
